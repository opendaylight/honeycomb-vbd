 ...
 *
 * NodeSpotter registers listener which catches node-related changes from topology-netconf. Provided
 ...
 *
 */
class NodeSpotter implements ClusteredDataTreeChangeListener<Node> {

    private static final Logger LOG = LoggerFactory.getLogger(NodeSpotter.class);

    private final ListenerRegistration<NodeSpotter> registeredListener;
    ...
    NodeSpotter(final Node node, final SettableFuture<Boolean> futureStatus, final DataBroker dataBroker) {
