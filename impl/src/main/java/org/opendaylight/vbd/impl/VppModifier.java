...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.vbridge.topology.rev160129.network.topology.topology.node.termination.point._interface.type.VirtualDomainCarrierCase;
    ...
    private ListenableFuture<Optional<Ipv4AddressNoZone>> readIpAddressFromVpp(@Nonnull DataBroker localDataBroker,
        ...
        for (org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.interfaces.rev140508.interfaces.state.Interface intf : opInterfaceState
            ...
            try {
                ...
                if (tpAug != null && tpAug.getInterfaceType() instanceof VirtualDomainCarrierCase) {
