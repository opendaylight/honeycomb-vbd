...
public class VbdNetconfTransaction {
     ...
     */
    public static synchronized <T extends DataObject> boolean netconfSyncedWrite(@Nonnull final DataBroker mountpoint,
     ...
     * @return true if transaction is successful, false otherwise
     */
    public static synchronized <T extends DataObject> boolean netconfSyncedDelete(@Nonnull final DataBroker mountpoint,
